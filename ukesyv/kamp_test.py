...
# Simulerer kampene et antall ganger
for simulering in range(antall_simuleringer):
    if simulering == 0:
        print()
        print("Eksempel-sesong:")
    for runde in runder:
        if simulering == 0:
            print()
        for kamp in runde:
            ...
            # printer bare første simulering
            if simulering == 0:
                print(kamp)

            # Teller opp resultater
...
# Skriver ut statistikk fra simuleringene
print()
...
print()
print("Snitt mål/kamp: ", round(sum_mål / kamper_totalt, 2), "(3.09 i virkeligheten)")
print("Poeng: ", poeng, "av maks 100 (høyere = mer realistisk)")
print("Prosent hjemmeseire:", hjemmeseier_prosent, "(50 i virkeligheten)")
print()